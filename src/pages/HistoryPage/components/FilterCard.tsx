...
import { Button, Card, DatePicker, Descriptions, Divider, Empty, Select, Space } from "antd";
...
const FilterCard = ({ days }: FilterCardProps) => {
    ...
    useEffect(() => {
        if (date) {
            if (type === "date") {
                //TODO: за день может быть несколько смен
                    ...
                    <>
                        ...
                        </Descriptions>
                        {
                            ...
                            <Space direction="horizontal">
                                <Button type="primary" ghost disabled={true}>Переоткрыть</Button>
                                <Button type="primary" danger ghost onClick={deleteDay}>Удалить</Button>
                            </Space>
                        }
                    </>
                }
